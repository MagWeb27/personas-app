            ...
            <table class="w-[90%] bg-white border border-gray-300 mx-auto shadow-xl">
                <thead class="bg-slate-400">
                    <tr class="text-white">
                        ...
                        <th class="py-2 px-4 border-b">Capital</th>
                ...
                <tbody>
                    @foreach ($pais as $pais)
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b text-center">{{ $pais->pais_nomb }}</td>
                            <td class="py-2 px-4 border-b text-center">{{ $pais->pais_capi }}</td>
                            <td class="py-2 px-4 border-b flex items-center justify-center">

                                <a href="{{ route('paises.edit', ['pais' => $pais->pais_nomb]) }}"
